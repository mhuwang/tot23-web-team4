  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <List item-layout="horizontal" :split="false">
        ...
        <div v-if="statefulSet.spec.replicas" class="metadata-item">
          <p>期望</p>
...
export default {
  ...
  computed: {
    ...
    labels() {
      const labelArr = []
      for (const pro in this.statefulSet.metadata.labels) {
        labelArr.push({
          key: pro,
    ...
    annotations() {
      const annoArr = []
      for (const anno in this.statefulSet.metadata.annotations) {
        annoArr.push({
          key: anno,
    ...
    matchLabels() {
      ...
      for (const i in this.statefulSet.spec.selector.matchLabels) {
  ...
  mounted: function() {
    ...
    this.$store
      ...
      .then((res) => {
        console.log(res)
        this.statefulSet = res.data.statefulSet
